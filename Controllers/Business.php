    ...
    class Business extends Controllers{
        ...
        public function mikrotik(){
            if($_POST){
                $id = $_SESSION['businessData']['id'];
                if($_SESSION['permits_module']['a']) {
                  $request = $this->model->update_mikrotik($id, [
                    "mikrotik_endpoint" => strClean($_POST['mikrotik_endpoint']),
                    "mikrotik_client" => strClean($_POST['mikrotik_client']),
                    "mikrotik_token" => strClean($_POST['mikrotik_token'])
                  ]);
                }
                if($request){
                  $this->json([
