                ...
                for($i=0; $i < count($data); $i++){
                    ...
                    if($_SESSION['permits_module']['v']){
                      ...
                      if($data[$i]['state'] == 1){
                        ...
                        $print = '<a href="javascript:;" class="black printer" data-toggle="tooltip" data-original-title="Ficha de instalación" onclick="installation_sheet(\''.encrypt($data[$i]['id']).'\')"><i class="far fa-file-pdf"></i></a>';
                        $print_2 = '<a href="javascript:;" class="dropdown-item" onclick="installation_sheet(\''.encrypt($data[$i]['id']).'\')"><i class="far fa-file-pdf mr-1"></i>Ficha de instalación</a>';
                      }else{
                        $email = '';
                        $email_2 = '';
                        $print = '';
                      ...
                      if($radio_option == 1){
                        ...
                        if(isset($request_bill)){
                          if($request_bill == "success"){
                            ...
                            /* OBETENER LOS DIAS DE DIERENCIA ENTRE EL CONTRATO Y ULTIMO DIA DEL MES */
