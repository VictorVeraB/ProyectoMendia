	...
	class BillsModel extends Mysql{
		...
		public function list_records(string $start,string $end,string $state){
				if(isset($start) && isset($end) && isset($state) && !empty($start) && !empty($end) && !empty($state)){
						$sql = "SELECT b.id,b.clientid,CONCAT_WS(' ', c.names, c.surnames) AS client,zona,b.internal_code,b.correlative,b.date_issue,b.expiration_date,b.billed_month,b.discount,b.subtotal,b.total,b.type,b.sales_method,b.remaining_amount,b.amount_paid,b.state,vs.serie,v.voucher,b.observation
						FROM bills b
		...
		public function list_pendings(){
			$sql = "SELECT b.id,b.clientid,CONCAT_WS(' ', c.names, c.surnames) AS client,zona,b.internal_code,b.correlative,b.date_issue,b.expiration_date,b.billed_month,b.discount,b.subtotal,b.total,b.remaining_amount,b.amount_paid,b.type,b.sales_method,b.state,vs.serie,v.voucher,b.observation, b.compromise_date
			FROM bills b
			JOIN clients c ON b.clientid = c.id
			JOIN vouchers v ON b.voucherid = v.id
			JOIN voucher_series vs ON b.serieid = vs.id
		...
		public function export(){
    		$sql = "SELECT b.id,b.clientid,CONCAT_WS(' ', c.names, c.surnames) AS client,zona,mobile,b.internal_code,b.correlative,b.date_issue,b.expiration_date,b.billed_month,b.discount,b.subtotal,b.total,b.type,b.state,vs.serie,v.voucher,b.observation
			FROM bills b
			JOIN clients c ON b.clientid = c.id
			JOIN vouchers v ON b.voucherid = v.id
			JOIN voucher_series vs ON b.serieid = vs.id
		...
		public function export_pendings(){
			$sql = "SELECT b.id,b.clientid,CONCAT_WS(' ', c.names, c.surnames) AS client,zona,mobile,b.internal_code,b.correlative,b.date_issue,b.expiration_date,b.billed_month,b.discount,b.subtotal,b.total,b.remaining_amount,b.amount_paid,b.type,b.sales_method,b.state,vs.serie,v.voucher,b.observation, b.compromise_date
			FROM bills b
			JOIN clients c ON b.clientid = c.id
			JOIN vouchers v ON b.voucherid = v.id
			JOIN voucher_series vs ON b.serieid = vs.id
		...
		public function select_invoice(int $client){
            ...
            $discount = 0;
				  ...
				  /* CONSULTA PARA OBTENER SI TIENE SERVICIOS EL CLIENTE */
