...
<head>
  ...
  <link rel="stylesheet" href="<?= base_style() ?>/css/newnew.css">
  ...
  <div class="mt-5 container">
    ...
    <div id="result" style="display: none;">
      <div class="d-flex justify-content-center mt-5">
        ...
        <h4 id="text-result">Resultados de:</h4>
        <h4 id="text-deuda"> DEUDA TOTAL: <?php echo $_SESSION['businessData']['symbol'] . $deuda_total; ?></h4>
      </div>
          <h4 id="text-result2" style="display: none;">MEDIOS DE PAGO: </h4>
          <h5 id="text-result3" style="display: none;">
        <a href="<?= MEDIOSDEPAGO ?>" target="_blank" class="btn btn-info" style="font-size: 16px; padding: 10px 20px; margin: 5px;">
          <i></i> DESCARGAR
        </a>
      </h5>
       <h4 id="text-result4" style="display: none;"></h4>

          <div class="table-responsive">
            <table id="list" class="table table-bordered dt-responsive nowrap dataTable dtr-inline collapsed" data-order='[[ 0, "desc" ]]' style="width: 100%;">
              <thead>
                <tr>
                  <th>Nº Factura</th>
                  <th>Mes Fact.</th>
