...
<div class="panel panel-default panel-clients">
  ...
  <div class="panel-body border-panel">
      ...
      <?php if(!$data['simple']): ?>
        <div class="btn-group">
          <button type="button" 
            class="btn btn-white" 
            data-toggle="tooltip" 
            data-original-title="Exportar clientes" 
            onclick="exports();">
    ...
    <div class="options-group btn-group m-r-0">
        <?php if($_SESSION['permits_module']['r'] && !$data['simple']): ?>
            <button type="button" class="btn btn-white btn-sm py-1" onclick="add()">
                <i class="fas fa- mr-1"></i>Nuevo
            </button>
            ...
            <?php if($data['simple']):?>
              ...
              <div class="col-5 col-md-2 col-lg-2 mb-1">
                <select 
                  ...
                  id="filterStart"
                  onchange="changeFilterDays('filterStart')"
                >
              ...
              <div class="col-5 col-md-2 col-lg-2 mb-1">
                <select 
                  ...
                  id="filterOver"
                  onchange="changeFilterDays('filterOver')"
                >
                  <option value="DESC">01</option>
                </select>
              </div>
