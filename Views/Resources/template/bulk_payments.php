        ...
        <div class="col-md-5">
          ...
          <div class="row justify-center pl-3 pr-3 mb-3">
            <div class="col-md-6 form-group pr-0" id="content_total_pay">
              ...
              <div class="input-group">
                ...
                <input style="background-color: #C8C5C5;"
                  type="text" 
            ...
            <div class="col-md-6 form-group pr-0" id="content_total_discount">
              <label>DESCUENTO ANTERIOR</label>
              <div class="input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text"><b><?= $_SESSION['businessData']['symbol'] ?></b></span>
                </div>
                <input style="background-color: #C8C5C5;"
                  ...
                  name="discount" 
                  disabled
                  value="<?= format_money($data['discount']) ?>">
              </div>
            </div>
          </div>
          <div class="row justify-center pl-3 pr-3 mb-3">
            ...
            <div class="col-md-6 form-group pr-0" id="content_total_discount">
              ...
              <div class="input-group">
                ...
                <input 
                  ...
                  value="<?= format_money($data['last_discount']) ?>">
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-12 m-t-10">
            <div class="form-group text-center">
              ...
              <button type="submit" class="btn btn-primary" id="btn_pay"><i class="fas fa-save mr-2"></i>Registrar pago</button>
            </div>
          </div>
          </div>
        </div>
