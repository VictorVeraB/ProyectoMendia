        ...
        <div class="footer" id="footer">
          Copyright &copy;2021 - <script>document.write(new Date().getFullYear())</script> <a class="f-w-700 f-s-13" style="color:#4e5c68;" href="<?= DEVELOPER_WEBSITE ?>" target=”_blank”><?= $_SESSION['businessData']['business_name'] ?></a>
		    </div>-->
    ...
    <script src="<?= base_style() ?>/js/mikrotik.js"></script>
    <!-- ================== FIN ARCHIVOS JS =========== -->
    ...
    <!-- ================== FIN FUNCION JS =============== -->
     <?php } ?>
      ...
      <!-- MIKROTIK -->
      <input type="hidden" id="mikrotik_endpoint_value" value="<?= $_SESSION['businessData']['mikrotik_endpoint'] ?>" />
      <input type="hidden" id="mikrotik_token_value" value="<?= $_SESSION['businessData']['mikrotik_token'] ?>" />
      <!-- MONEDA -->
