	...
	<body>
		<table class="tbl-logo">
            ...
            <?php if(file_exists($logo)): ?>
                <img src="<?= base_url()."/".$logo ?>" style="max-height:70px;">
            <?php else: ?>
                <img src="<?= base_style().'/images/logotypes/superwisp.png' ?>" style="max-height:70px;">
            <?php endif; ?>
					</td>
					<td class="text-right wd33">
						<p>Nº. Instalación: <strong><?= $code ?></strong><br>
        ...
        <table>
            <tr>
                <td class="text-center titulo"><strong>FICHA DE INSTALACIÓN</strong></td>
            </tr>
        </table>
        <table class="tbl-cliente">
            <thead class="table-head">
                <tr>
                    <th colspan="2" bgcolor="rgb(25 221 221 / 38%)" class="text-left">DATOS DEL CLIENTE</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    <td><strong>N° <?= $bill['type_doc'] ?></strong></td>
            ...
            <tr>
                <?php
                $mobile = '';
                if (!empty($facility['zona'])) {
                    $mobile .= $facility['zona'];
                }
                ?>
        ...
        <table class="tbl-servicio">
            <thead class="table-head">
                <tr>
                    <th colspan="2" bgcolor="rgb(25 221 221 / 38%)" class="text-left">CARACTERÍSTICAS DE LA INSTALACIÓN</th>
                </tr>
            </thead>
            <tbody>
              <tr>
        ...
        <table class="tbl-servicio">
            <thead class="table-head">
                <tr>
                    <th bgcolor="rgb(25 221 221 / 38%)" class="text-left">PLAN</th>
                </tr>
            </thead>
            <tbody>
        ...
        <table class="tbl-producto">
            <thead class="table-head">
                <tr>
                    <th bgcolor="rgb(25 221 221 / 38%)" class="text-left">PRODUCTO</th>
                    <th bgcolor="rgb(25 221 221 / 38%)" class="text-center">SERIE</th>
                    <th bgcolor="rgb(25 221 221 / 38%)" class="text-center">MAC</th>
                    <th bgcolor="rgb(25 221 221 / 38%)" class="text-center">CONDICIÓN</th>
                    <th bgcolor="rgb(25 221 221 / 38%)" class="text-center">PRECIO</th>
                    <th bgcolor="rgb(25 221 221 / 38%)" class="text-center">CANTIDAD</th>
                    <th bgcolor="rgb(25 221 221 / 38%)" class="text-center">IMPORTE</th>
                </tr>
            </thead>
            <tbody>
              <?php if(!empty($tools)): ?>
        ...
        <table class="tbl-observacion">
            <thead class="table-head">
                <tr>
                    <th bgcolor="rgb(25 221 221 / 38%)" class="text-left">DETALLES</th>
                </tr>
            </thead>
            <tbody>
                <tr>
