    ...
    <div class="row">
      <table width="100%">
				<tbody>
					<tr style="padding: 0px;">
						...
						<p style="font-size: 9px; text-align: center;">
							<span style="font-family:arial,helvetica,sans-serif;">
								<span style="font-size:11px;"><strong>WEB:</strong> <?= DEVELOPER_WEBSITE ?></span>
							</span>
						</p>
      ...
      <table width="100%">
			...
			<table width="100%">
              ...
              <?php if(isset($bill['compromise_date'])){?>
                <hr class="hr">
                <p style="font-size:9px;">
                  <span style="font-size:11px;">
                    <span style="font-family:arial,helvetica,sans-serif;">
                      <strong>FECHA COMPROMISO: </strong> <?= date_format(date_create($bill['compromise_date']), "Y/m/d") ?>
                    </span>
                  </span>
                </p>
              <?php }?>
