            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="padding: 0 15px">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <input type="text" 
                              ...
                              onchange="formatMoneyInput('purchase_price')"
                              placeholder="0.00" 
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <input type="text" 
                              ...
                              id="sale_price" 
                              onkeypress="return decimal(event)" 
                              onchange="formatMoneyInput('sale_price')"
                              placeholder="0.00"
                              data-parsley-required="true"
                            >
                        </div>
                  ...
                  <div class="checkbox checkbox-css">
                    ...
                    <?php //<label for="extra" class="cursor-pointer">Agregar información extra</label>?>
                  </div>
                </div>
                <div id="cont-serie" class="col-md-3 form-group" style="display:none">
                  <?php //<label class="control-label">Nº Serie</label>?>
                  <input type="text" class="form-control text-uppercase" name="serie" id="serie"
                    placeholder="7505127807" onkeypress="return numbers(event)" maxlength="9">
                </div>
                <div id="cont-mac" class="col-md-3 form-group" style="display:none">
                  <?php //<label class="control-label">Mac (opcional)</label>?>
                  <input type="text" class="form-control text-uppercase" name="mac" id="mac"
