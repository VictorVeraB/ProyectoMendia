          ...
          <div class="row">
            ...
            <div class="col-md-3 form-group">
              ...
              <input type="text" 
                ...
                onchange="formatMoneyInput('price_internet')"
                placeholder="0.00" 
                ...
                <table class="table table-bordered table-invoice" id="table-free">
                  <thead>
                    <tr>
                      ...
                      <th style="border-color:#2d353c" class="text-uppercase f-s-12 text-left" width="40%">Descripción</th>
  ...
  <form autocomplete="off" name="transactions_facser" id="transactions_facser">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body row">
           <input type="hidden" class="form-control" name="billed_month" id="billed_month">
            ...
            <div class="invoice-content">
              <div class="table-responsive">
                <table id="table-plans" class="table table-bordered table-invoice">
                  <thead>
                    <tr>
                      <th style="border-color:#2d353c" class="table-header text-uppercase f-s-12 text-left" width="40%">Descripción</th>
                    ...
                    <tr>
                      ...
                      <td colspan="2">
                        <input type="text" 
                          ...
                          name="discount" 
                          value="0.00"
                          onchange="formatMoneyInput('discountserv')"
                        >
                      </td>
                    </tr>
                  </tfoot>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-md-12 row justify-between">
              <div class="col-md-6 form-group">
                <label for="total_payment" class="control-label">Deuda Actual</label>
                <input 
                  type="text" 
                  class="form-control f-s-19 f-w-700 text-center" 
                  id="remaining_amount" 
              ...
              <div class="col-md-6 form-group">
                <label for="total_payment" class="control-label">Descuento</label>
                <div class="input-group">
                  <div class="input-group-prepend">
            ...
            <div class="col-md-12 form-group">
              <label for="total_pay" class="control-label">Total a Pagar</label>
              <input 
                type="text" 
                class="form-control f-s-19 f-w-700 text-center" 
                id="total_pay" 
                name="total_pay" 
                onkeypress="return decimal(event)"
                onchange="changePay(this)"
                placeholder="0.00" 
              >
              <div id="text-alert"></div>
            </div>

            <div class="col-md-12 form-group pr-0" style="display: none;" id="content_compromiso">
              <label>Fecha de Compromiso</label>
              <div class="input-group">
                <input type="input" class="form-control" id="date_compromiso" name="date_compromiso">
                <div class="input-group-append">
                  <span class="input-group-text"><i class="far fa-calendar"></i></span>
                </div>
              </div>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-blue" id="btn_pay">
            <i class="fas fa-save mr-2"></i>
            <span id="text-button-payment"></span>
          </button>
        </div>
      </div>
    </div>
          ...
          <div class="invoice-content">
            <div class="table-responsive">
              <table class="table table-bordered table-invoice" id="view-table">
                <thead>
                  <tr>
                    <th style="border-color:#2d353c" class="text-left text-uppercase f-s-12" width="40%">Descripción</th>
                    <th style="border-color:#2d353c" class="text-uppercase f-s-12" width="80px">Precio</th>
                    <th style="border-color:#2d353c" class="text-uppercase f-s-12" width="80px">Cantidad</th>
                    <th style="border-color:#2d353c" class="text-uppercase f-s-12" width="80px">Total</th>
                  </tr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
          ...
          <div class="col text-center font-weight-bold mt-3">
            <button type="button" class="btn btn-lg btn-whatsapp" id="btn-whatsapp-massive"><i class="fab fa-whatsapp fa-5x"></i></button>
