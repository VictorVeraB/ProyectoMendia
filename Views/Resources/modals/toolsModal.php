                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                            <label for="listProduct" class="control-label">Producto <b class="text-danger">*</b></label>
                        ...
                        <div id="divquantity" class="col-md-4 form-group" style="display:none">
                            <label for="quantity" class="control-label">Cantidad <b class="text-danger">*</b></label>
