                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="document" id="document" onkeypress="return numbers(event)" placeholder="99999999" maxlength="8">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" class="form-control" name="mobile" id="mobile" onkeypress="return numbers(event)" maxlength="9" placeholder="999999999" data-parsley-required="true">
                        </div>
