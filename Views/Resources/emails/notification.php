														...
														?>
															<tr>
																<td style="vertical-align: top;padding: 0 0 10px;">
																	<p><span style="font-size:12px;">Tiene un recibo de pago con 
                                    <strong><?= $information['voucher'] ?></strong> N° <strong><?= $information['invoice'] ?></strong>, 
                                    registrado el dia <strong><?= date_letters($information['issue']) ?></strong>, teniendo un total de <strong><?= $information['business']['symbol'].format_money($information['total_invoice']) ?></strong> <?= ucwords(strtolower($money)) ?>.</span></p>
																	...
																	<p style="line-height: 8px;"><span style="font-size:12px;"><strong>Subtotal:</strong> <?= $information['business']['symbol'].format_money($information['sub_invoice']) ?></span></p>
																	<p style="line-height: 8px;"><span style="font-size:12px;"><strong>Descuento:</strong> <?= $information['business']['symbol'].format_money($information['dis_invoice']) ?></span></p>
																	<p style="line-height: 8px;"><span style="font-size:12px;"><strong>Total:</strong> <?= $information['business']['symbol'].format_money($information['total_invoice']) ?></span></p>
																</td>
															</tr>
									                    <?php endif; ?>
