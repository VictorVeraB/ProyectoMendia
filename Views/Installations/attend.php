                ...
                <fieldset>
                  <div class="row row-space-30">
                      <div class="col-xl-9">
                          ...
                          <label class="col-md-3 text-lg-right col-form-label">N° <?= isset($information['type_doc']) ? $information['type_doc'] : 'sin documento' ?></label>
                          <div class="col-md-4">
                          ...
                          <div class="form-group row">
                              <label class="col-md-3 text-lg-right col-form-label">Celular</label>
                              <div class="col-md-9">
                                  <input type="text" class="form-control m-b-10" value="<?= $information['mobile'] ?>" readonly>
                              </div>
                          </div>
                          <div class="form-group row">
                              <label class="col-md-3 text-lg-right col-form-label">Dirección IP</label>
                              <div class="col-md-9">
                                  <input type="text" class="form-control" value="<?= $information['mobile_optional'] ?>" readonly>
                                  <small class="text-success text-uppercase m-b-10">PARA INSTALACIONES CON MAS DE 1 IP, CREAR NUEVO CLIENTE O AGREGAR IP EN DETALLES DE INSTALACION</small>
                              </div>
                          </div>
                          <div class="form-group row">
                              <label class="col-md-3 text-lg-right col-form-label">Zona</label>
                              <div class="col-md-9">
                                  <input type="text" class="form-control" value="<?= $information['zona'] ?>" readonly>
                              </div>
                          </div>
                          <div class="form-group row">
                              <label class="col-md-3 text-lg-right col-form-label">AP Cliente</label>
                              <div class="col-md-9">
                                  <input type="text" class="form-control" value="<?= $information['ap_cliente_text'] ?>" readonly>
                              </div>
                          </div>
                          <div class="form-group row">
