                            ...
                            <div class="card-body">
                              <form autocomplete="off" name="transactions_general" id="transactions_general" class="row row-space-30">
                                  <div class="col-xl-12">
                                      ...
                                      <div class="form-group row m-b-10">
                                          <label class="col-md-3 text-lg-right col-form-label">N° Ruc <span class="text-danger">*</span></label>
                                          <div class="col-md-8">
    ...
    <div id="collapseThirteen" class="collapse" data-parent="#accordionTree" style="">
        <div class="card-body">
            <form autocomplete="off" name="transactions_whatsapp" id="transactions_whatsapp" class="row row-space-30">
                <div class="col-xl-12">
                    <div class="form-group row m-b-10">
                        <label class="col-md-3 text-lg-right col-form-label">ENDPOINT URL</label>
                        <div class="col-md-8">
                ...
                <div class="col-xl-12">
                    <div class="form-group row m-b-10">
                        ...
                        <div class="col-md-8">
                            ...
                            <small>Para adquirir acceso contacte: <a href="https://api.whatsapp.com/send?phone=+51999220735&text=Hola%20deseo%20obtener%20un%20*TOKEN*%20de%20API%20WhatsApp,%20para%20usar%20en%20la%20plataforma%20*SISTEMA%20WISP*" target="_blank">WhatsApp</a></small>
                        </div>
                    </div>
                    <div class="form-group row justify-content-center">
                        <button type="submit" class="btn btn-blue">
...
<!--<div class="card">
    <div class="card-header pointer-cursor d-flex align-items-center" data-toggle="collapse" data-target="#collapseMikrotik" aria-expanded="false">
        <img src="<?= base_style() ?>/images/default/mikrotik.png" class="image-apis mr-1">
    </div>
    <div id="collapseMikrotik" class="collapse" data-parent="#accordionTree" style="">
        <div class="card-body">
            <form autocomplete="off" name="transactions_mikrotik" id="transactions_mikrotik" class="row row-space-30">
                <div class="col-xl-12">
                    <div class="form-group row m-b-10">
                        <label class="col-md-3 text-lg-right col-form-label">ENDPOINT URL</label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" value="<?= $_SESSION['businessData']['mikrotik_endpoint'] ?>" name="mikrotik_endpoint" id="mikrotik_endpoint">
                        </div>
                    </div>
                    <div class="form-group row m-b-10">
                        <label class="col-md-3 text-lg-right col-form-label">CLIENTE URL</label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" value="<?= $_SESSION['businessData']['mikrotik_client'] ?>" name="mikrotik_client" id="mikrotik_client">
                        </div>
                    </div>
                </div>
                <div class="col-xl-12">
                    <div class="form-group row m-b-10">
                        <label class="col-md-3 text-lg-right col-form-label">TOKEN</label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" value="<?= $_SESSION['businessData']['mikrotik_token'] ?>" name="mikrotik_token" id="mikrotik_token">
                            <small>Para adquirir acceso contacte: <a href="https://api.whatsapp.com/send?phone=+51999220735&text=Hola%20deseo%20obtener%20un%20*TOKEN*%20de%20API%20Mikrotik,%20para%20usar%20en%20la%20plataforma%20*SISTEMA%20WISP*" target="_blank">WhatsApp</a></small>
                        </div>
                    </div>
                    <div class="form-group row justify-content-center">
                        <button type="submit" class="btn btn-blue">
