            ...
            <div class="login-content">
                <form name="transactions" id="transactions" autocomplete="off" class="margin-bottom-0">
                    ...
                    <div class="m-t-10" style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <div>
                            <a href="<?= FACEBOOKLOG ?>" target="_blank" style="margin-right: 20px;"><i class="fab fa-facebook fa-3x"></i></a>
                            <a href="<?= WHATSAPPLOG ?>" target="_blank"><i class="fab fa-whatsapp fa-3x"></i></a>
                        </div>
                    </div>
            </div>
            </form>
