<?php
/* RUTA DEL SISTEMA */
const BASE_URL = "https://omgnetworks.net.pe";
/* ZONA HORARIA*/
...
const DB_NAME = "purgar"; //nombre base de datos
const DB_USER = "miusuario"; //usuario
const DB_PASSWORD = "miclave"; //contraseña
const DB_CHARSET = "utf8";
/* BACKUP */
const TABLES_NAME = "Tables_in_u395713662_wispomg"; //backups - Tables_in_nombreBD
