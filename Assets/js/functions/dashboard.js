  ...
  http.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      if (objData.status == "success") {
        ...
        degraded1.addColorStop(0, "rgba(241, 44, 44)"); // sombra arriba
        degraded1.addColorStop(1, "rgba(255, 199, 199)"); //sombra abajo
        var degraded2 = ctx.createLinearGradient(0, 0, 0, 300);
        degraded2.addColorStop(0, "#00390d");
              ...
              xAxes: [
                {
                  ...
                  gridLines: {
                    display: true,
                    color: "rgba(255, 18, 18)", //raya vertical
                  },
                },
              ],
              yAxes: [
                {
                  ...
                  gridLines: {
                    display: true,
                    color: "rgba(255, 18, 18)", //rayas del cuadro
                  },
                },
              ],
            },
